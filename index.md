...
|3||화면요소|옷장 버튼|클릭 시 옷장 화면으로 넘어감.|
|3||화면요소|스텟 창|몸무게, 스트레스, 행복지수|
|3||화면요소|날짜|D-day를 알려줌.|
|3||스트립트 요소|Day|7일부터 0일이 될 때 까지 함. 외출 2번을 했을 때 바뀜.|
|3||스트립트 요소|Weight|현재 캐릭터 몸무게|
|3||스트립트 요소|Stress|현재 캐릭터 스트레스|
|3||스트립트 요소|Happy|현재 캐릭터 행복지수|
|4|외출 화면|메인 화면에서 외출버튼을 누르면 뜨는 창.|||
|4||화면요소|등산 버튼|등산을 하는 모습이 뜸.|
|4||화면요소|헬스장 버튼|헬스장에서운동을 하는 모습이 뜸.|
|4||화면요소|공원 창|공원에서 산책하는 모습이 뜸|
|4||화면요소|오락실 버튼|오락실 미니게임.|
|4||화면요소|먹거리 버튼|캐릭터가 먹는 모습이 뜸.|
|4||스트립트 요소|Weight_w|외출을 했을 떄 증가, 감소하는 몸무게.|
|4||스트립트 요소|Stress_s|외출을 했을 떄 증가, 감소하는 스트레스.|
|4||스트립트 요소|Happy_h|외출을 했을 떄 증가, 감소하는 행복지수.|
|5|엔딩화면|마지막 게임이 끝날 때 뜨는 엔딩 창|||
|5||화면 요소|메인엔딩|다시하기 / 끝내기 버튼이 뜸.|
|5||화면 요소|서브엔딩|다시하기 / 끝내기 버튼이 뜸.|
|5||화면 요소|게임오버엔딩|다시하기 / 끝내기 버튼이 뜸.|
