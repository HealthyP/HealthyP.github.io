...
|속성|영문영칭|설명|비고|
|:----:|:----:|:----:|:----:|
|등산|Hiking|외출의 한 가지 운동종류, 몸무게(-), 스트레스(+), 행복지수(-)에 영향을 준다.|몸무게 –2kg, 스트레스 +10%, 행복지수 –3%|
|헬스장|PT|외출의 한가지 운동종류, 몸무게(-), 스트레스(+), 행복지수(-)에 영향을 준다.|몸무게 –4kg, 스트레스 +20%, 행복지수 –5%|
|공원|Park|외출의 한 가지 운동종류, 몸무게(-), 스트레스(+), 행복지수(-)에 영향을 준다.)|몸무게 –1kg, 스트레스 +5%, 행복지수 –2%|
|오락실|Game|외출의 한 가지 취미종류, 스트레스(-), 행복지수(+)에 영향을 준다.|몸무게 0kg, 스트레스 -10%, 행복지수 +20%|
|먹거리|Food|외출의 한 가지 취미종류, 몸무게(+), 스트레스(-), 행복지수(+)에 영향을 준다.|몸무게 +3kg, 스트레스 -20%, 행복지수 –10%|
