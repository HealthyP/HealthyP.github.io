...
|----|:----:|----|----|----|
|1|시작화면|게임 첫 시작 화면|||
|||화면요소|게임 시작 버튼|클릭 시 스토리 화면으로 넘어감.|
|2|스토리 화면|시작 화면 다음으로 나오는 상황설명 화면| | |
|||화면요소|말풍선 창|캐릭터가 말풍선에 글씨로 상황을 설명해 줌.|
|||스트립트 요소|Space|다음 장 넘기기|
|3|메인화면|스토리 화면을 다 읽고 넘어오면 나오는 게임 메인 화면|||
|||화면요소|외출 버튼|클릭 시 외출 화면으로 넘어감.|
||||옷장 버튼|클릭 시 옷장 화면으로 넘어감.|
||||스텟 창|몸무게, 스트레스, 행복지수|
||||날짜|D-day를 알려줌.|
|||스트립트 요소|Day|7일부터 0일이 될 때 까지 함. 외출 2번을 했을 때 바뀜.|
||||Weight|현재 캐릭터 몸무게|
||||Stress|현재 캐릭터 스트레스|
||||Happy|현재 캐릭터 행복지수|
|4|외출화면|메인 화면에서 외출버튼을 누르면 뜨는 창.|||
|||화면요소|등산 버튼|등산을 하는 모습이 뜸.|
||||헬스장 버튼|헬스장에서운동을 하는 모습이 뜸.|
||||공원 창|공원에서 산책하는 모습이 뜸|
||||오락실 버튼|오락실 미니게임.|
||||먹거리 버튼|캐릭터가 먹는 모습이 뜸.|
|||스트립트 요소|Weight_w|외출을 했을 떄 증가, 감소하는 몸무게.|
||||Stress_s|외출을 했을 떄 증가, 감소하는 스트레스.|
||||Happy_h|외출을 했을 떄 증가, 감소하는 행복지수.|
|5|엔딩화면|마지막 게임이 끝날 때 뜨는 엔딩 창|||
|||화면요소|메인엔딩|다시하기 / 끝내기 버튼이 뜸.|
||||서브엔딩|다시하기 / 끝내기 버튼이 뜸.|
||||게임오버엔딩|다시하기 / 끝내기 버튼이 뜸.|
