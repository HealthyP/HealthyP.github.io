...
|No|화면|  |용어|설명|
|:----:|:----:|:----:|:----:|:----:|
|1|시작화면|게임 첫 시작 화면|게임 첫 시작 화면|게임 첫 시작 화면|
|1|시작|화면요소|게임 시작 버튼|클릭 시 스토리 화면으로 넘어감.|
|2|스토리 화면|시작 화면 다음으로 나오는 상황설명 화면|시작 화면 다음으로 나오는 상황설명 화면|시작 화면 다음으로 나오는 상황설명 화면|
